...
class UserScores:
    def __init__(self, discord_id):
        ...
        self.scores = [UserScore(discord_id, ScoreMods(code=mods), pp, accuracy, combo, ar, cs, speed,
